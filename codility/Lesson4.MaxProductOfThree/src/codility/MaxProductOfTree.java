...
public class MaxProductOfTree {
	 ...
	 * product of triplet (P, Q, R) equates to A[P] * A[Q] * A[R] (0 ¡Â P < Q < R
	 * < N).
	 * 
	...
	public static int solution(int[] A) {
		...
		// Compare left product value with right product value
		value1 = A[A.length - 1] * A[A.length - 2] * A[A.length - 3];
		if (A[0] < 0 && A[1] < 0) {
			value2 = A[0] * A[1] * A[A.length - 1];
		}
